                ...
                >
                    <div className="p-6 bg-black  w-full h-full rounded-xl grid grid-cols-2 gap-2">
                        ...
                        <div className='hover:scale-90 transition duration-700'>
                            <img src="https://i.ibb.co/vvTygZBC/Screenshot-2025-06-28-215950.png" alt="" />
                        </div>

                        <div className='hover:scale-90 transition duration-700'>
                            <img src="https://i.ibb.co/n90DJdh/Screenshot-2025-06-28-220002.png" alt="" />
                        </div>
                        <div className='hover:scale-90 transition duration-700'>
                            <img src="https://i.ibb.co/nNNwBT61/Screenshot-2025-06-28-220017.png" alt="" />
                        </div>

                        <div className='hover:scale-90 transition duration-700'>
                            <img src="https://i.ibb.co/xqn7Bq7Y/Screenshot-2025-06-28-220128.png" alt="" />
                        </div>
                    ...
                    <div className="p-6 bg-black rounded-xl text-white space-y-4">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-1 text-sm">
                                <li>🔍 Easily find your next roommate</li>
                                <li>📋 View detailed roommate profiles</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-sm">
                                You can filter out roommates based on your preferences and explore profiles with ease.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <a href={'https://room-mate-application-ee4a3.web.app/'} >
                            ...
                            <a href="https://github.com/adnan683515/room-mate-client-j">
                                <ShimmerButton className='p-1 sm:p-3'>
