    ...
    return (
        <div className="flex relative overflow-hidden justify-center items-center bg-black  px-4">
            <motion.div
                ...
                div className="sm:space-y-4 space-y-2 text-center sm:text-start">

                <TypingAnimation duration={100} className='text-white  text-2xl sm:text-5xl' startOnView={true}>
                    Golam Faruk Adnan
                </TypingAnimation>
                ...
                <BoxReveal boxColor="white" duration={0.5}>
                    <p className="text-[var(--text-color)] sm:font-semibold w-[98%] sm:w-[75%]">
                        Web developer from <span className="text-[var(--secondary-color)]">Bangladesh</span>, building modern web applications.
                    </p>
                </BoxReveal>
